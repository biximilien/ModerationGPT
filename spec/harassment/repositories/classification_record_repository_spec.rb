...
describe Harassment::Repositories::ClassificationRecordRepository do
  ...
  it "requires subclasses to implement #find" do
    expect do
      repository.find(message_id: "123", classifier_version: "harassment-v1")
    end.to raise_error(NotImplementedError, /must implement #find/)
  end

  it "requires subclasses to implement #all_for_message" do
    expect { repository.all_for_message("123") }.to raise_error(NotImplementedError, /must implement #all_for_message/)
  end

  it "requires subclasses to implement #latest_for_message" do
    expect { repository.latest_for_message("123") }.to raise_error(NotImplementedError, /must implement #latest_for_message/)
  end
end
